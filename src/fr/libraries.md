...
> **Règle {{#check LIBS-VETTING-DIRECT | Validation des dépendances tierces directes}}**
>
...
> **Recommandation {{#check LIBS-VETTING-TRANSITIVE | Validation des dépendances tierces transitives}}**
>
